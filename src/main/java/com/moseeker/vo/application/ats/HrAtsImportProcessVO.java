...
public class HrAtsImportProcessVO {
    ...
    @ApiModelProperty(name = "userId", value = "邮箱", dataType = "string", required = true, example = "example@moseeker.com")
    private String email;
    @ApiModelProperty(name = "positionId", value = "职位ID", dataType = "int", required = true, example = "52635")
    private Integer positionId;
    @ApiModelProperty(name = "userId", value = "//阶段标识（目标阶段", dataType = "int", required = true, example = "666")
