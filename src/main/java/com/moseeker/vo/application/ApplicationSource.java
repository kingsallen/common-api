...
/**
 * Created by zztaiwll on 18/9/25.
 */
public enum ApplicationSource {
    ...
    EMPLOYEE_REFERRAL(65536,10000000000000000l),JOB58(131072,100000000000000000L),EMPLOYEE_REHIRING(2097152,2^21),EMPLOYEE_TRANSFER(4194304,2^22),TW104(1<<25,2^25L);
